...
@AllArgsConstructor
@NoArgsConstructor
public class FileRequestOfpptDto {
    ...
    private List<DetailsFileRequestOfpptDto> details;



    public List<DetailsFileRequestOfpptDto> getLignesRejet() {
    ...
    public List<DetailsFileRequestOfpptDto> getLignesValides() {
        if (CollectionUtils.isEmpty(getDetails())) {
            return null;
        }
