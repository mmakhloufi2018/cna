...
@AllArgsConstructor
@NoArgsConstructor
public class FileRequestMesrsiDto {
    ...
    private List<DetailsFileRequestMesrsiDto> details;


    public List<DetailsFileRequestMesrsiDto> getLignesRejet() {
    ...
    public List<DetailsFileRequestMesrsiDto> getLignesValides() {
        if (CollectionUtils.isEmpty(getDetails())) {
            return null;
        }
