...
@AllArgsConstructor
@NoArgsConstructor
public class FileRequestMhaiDto {
    ...
    private List<DetailsFileRequestMhaiDto> details;

    public List<DetailsFileRequestMhaiDto> getLignesRejet() {
    ...
    public List<DetailsFileRequestMhaiDto> getLignesValides() {
        if (CollectionUtils.isEmpty(getDetails())) {
            return null;
        }
