...
@Entity
@Table(name = "DATA_CAP_FOR_MEM")
public class DataCapForMemEntity {
	...
	@Column(name = "LIEN_AVEC_DEMANDEUR")
	private String lienAvecDemandeur;
	@Column(name = "AGE")
	private Integer age;
	...
	public String getLienAvecDemandeur() {
		return lienAvecDemandeur;
	}

	public void setLienAvecDemandeur(String lienAvecDemandeur) {
		this.lienAvecDemandeur = lienAvecDemandeur;
	}
	...
	public DataCapForMemEntity(Long id, String moisAnnee, Long dossier, Long membre, String salarie,
			String pensionne, String beneficieAF, String resideMaroc, String codeRsu, String lienAvecDemandeur,
			Integer age) {
		super();
		this.id = id;
		this.moisAnnee = moisAnnee;
