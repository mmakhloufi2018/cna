...
@Entity
@Table(name = "LOT_SITUATION_MASSAR_2025")
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
public class LotSituationMassar2025 extends LotSituationGen implements Serializable {
    ...
    private Set<DetailsLotSituationMassar2025> codeEleves;

    @JsonManagedReference
    @OneToMany(fetch = FetchType.EAGER, mappedBy = "lot", cascade = CascadeType.ALL)
    private Set<DemandeSituationMassar2025> demandes;
